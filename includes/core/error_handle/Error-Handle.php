...
* Error Handle calss
*/
class MXOBSErrorHandle
{

    /**
    * Error name
    */
    // public $mxobs_error_name = '';    
    ...
    public function classAttributesError( $className, $method )
    {
        ...
        if (class_exists($className)) {
            ...
            if (!method_exists($classInstance, $method)) {
                ...
                // show an error
                $errorMethodInstance = new MXOBSDisplayError( $errorNotice );
            ...
            // show an error
            $errorClassInstance = new MXOBSDisplayError( $errorNotice );
